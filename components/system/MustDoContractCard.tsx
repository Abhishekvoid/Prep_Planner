...
export function MustDoContractCard({ dayId = "day-1" }: Props) {
  ...
  return (
    <div className="reveal border border-rose-500/30 bg-[#0A0708] p-4 sm:p-5 rounded-lg text-slate-200 shadow-[0_0_25px_rgba(244,63,94,0.1)] relative overflow-hidden transition-all">
      ...
      <AnimatePresence mode="wait">
        {activeTab === "leetcode" ? (
          ...
          >
            ...
            {/* Problem Statement */}
            <div className="bg-[#050505] border border-white/10 p-3.5 rounded text-slate-200 leading-relaxed">
